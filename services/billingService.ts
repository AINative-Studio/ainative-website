...
export class BillingService {
  private readonly billingBasePath = '/api/v1/public/billing';
  private readonly subscriptionBasePath = '/api/v1/public/subscription';
  private readonly creditsBasePath = '/api/v1/public/credits';
