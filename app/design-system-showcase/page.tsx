...
export const metadata: Metadata = {
  ...
  description: 'Get access to 32 production-ready NPM packages, 57+ UI components, AINative Design MCP server, and premium UI components. Build stunning AI-native applications faster.',
  openGraph: {
  ...
  twitter: {
    ...
    title: 'AINative Design System & AI Kit | Build Beautiful AI-Native Interfaces',
    description: 'Get access to 32 production-ready NPM packages, 57+ UI components, AINative Design MCP server, and premium UI components.',
