...
describe('DesignSystemShowcaseClient', () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });
  ...
  describe('Rendering', () => {
    it('should render without crashing', () => {
      // Given
      const { container } = render(<DesignSystemShowcaseClient />);
    ...
    it('should display loading state initially', async () => {
      // Given
      render(<DesignSystemShowcaseClient />);
  ...
  describe('State Management', () => {
    it('should manage copiedIndex state', async () => {
      // Given
      render(<DesignSystemShowcaseClient />);

      // When
      // Interact with component to change copiedIndex
    ...
    it('should manage sliderValue state', async () => {
      // Given
      render(<DesignSystemShowcaseClient />);

      // When
      // Interact with component to change sliderValue
