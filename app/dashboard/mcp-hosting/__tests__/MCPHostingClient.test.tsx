...
describe('MCPHostingClient', () => {
  ...
  describe('Rendering', () => {
    it('should render without crashing', () => {
      // Given
      const { container } = render(<MCPHostingClient />);
  ...
  describe('State Management', () => {
    ...
    it('should manage selectedLogs state', async () => {
      // Given
      render(<MCPHostingClient />);

      // When
      // Interact with component to change selectedLogs
