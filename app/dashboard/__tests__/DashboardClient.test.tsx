...
describe('DashboardClient', () => {
  ...
  describe('State Management', () => {
    ...
    it('should manage sessionUser state', async () => {
      // Given
      render(<DashboardClient />);

      // When
      // Interact with component to change sessionUser

      // Then
      // expect(...).toBe(expectedValue);
    });

    it('should manage user state', async () => {
      // Given
      render(<DashboardClient />);

      // When
      // Interact with component to change user
