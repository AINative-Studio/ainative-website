...
describe('LoadTestingClient', () => {
  ...
  describe('Rendering', () => {
    it('should render without crashing', () => {
      // Given
      const { container } = render(<LoadTestingClient />);
  ...
  describe('State Management', () => {
    ...
    it('should manage selectedMetrics state', async () => {
      // Given
      render(<LoadTestingClient />);

      // When
      // Interact with component to change selectedMetrics
