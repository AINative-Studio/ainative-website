...
describe('AIKit Button Component - TDD Suite', () => {
  ...
  describe('User Interactions', () => {
    ...
    it('should handle double click events', async () => {
      ...
      const handleDoubleClick = jest.fn() as jest.Mock;
      const user = userEvent.setup();
    ...
    it('should handle hover states', async () => {
      ...
      const handleMouseEnter = jest.fn() as jest.Mock;
      const handleMouseLeave = jest.fn() as jest.Mock;
      const user = userEvent.setup();
  ...
  describe('Type Safety and Props', () => {
    ...
    it('should merge event handlers correctly', async () => {
      ...
      const onClick1 = jest.fn() as jest.Mock;
      const onClick2 = jest.fn() as jest.Mock;
      const user = userEvent.setup();
