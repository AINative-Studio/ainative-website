  ...
  private getImageGenerationModels(): UnifiedAIModel[] {
    const models = [
      ...
      },
      {
        ...
        thumbnail_url: getThumbnailUrl({ provider: 'AINative', category: 'Image' }),
        examplePrompts: [
  ...
  private getVideoGenerationModels(): UnifiedAIModel[] {
    return [
      ...
      },
      {
        ...
        thumbnail_url: getThumbnailUrl({ provider: 'AINative', category: 'Video' }),
        examplePrompts: [
  ...
  private getCodingModels(): UnifiedAIModel[] {
    ...
    return [
      ...
      },
      {
        ...
        thumbnail_url: getThumbnailUrl({ provider: 'AINative', category: 'Coding' }),
        examplePrompts: [
