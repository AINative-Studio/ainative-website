 ...
 */
let _serverEnvCache: ReturnType<typeof serverEnvSchema.parse> | null = null;
...
// Backward compatibility - lazy proxy that only evaluates on property access
export const serverEnv = new Proxy({} as ReturnType<typeof serverEnvSchema.parse>, {
  get(_target, prop) {
    return getServerEnv()[prop as keyof ReturnType<typeof serverEnvSchema.parse>];
  },
});
